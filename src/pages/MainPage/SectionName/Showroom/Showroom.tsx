...
export const Showroom: React.FC = () => {
  ...
  return (
    // <div className={cnShowroom()} style={{ ['--scroll' as any]: move.moveValue }} ref={section}>
    <div className={cnShowroom()}>
      <div className={cnShowroom('Row', { height: 'l' })}>
        <div className={cnShowroom('Group')}>
      ...
      <div className={cnShowroom('Row', { height: 'xs' })}>
        <div className={cnShowroom('Group')}>
          <Switch
            size="m"
            onChange={() => {}}
      ...
      <div className={cnShowroom('Row', { height: 'm' })}>
        <div className={cnShowroom('Group')}>
          <BasicSelect
            placeholder="Выберите город"
            size="m"
      ...
      <div className={cnShowroom('Row', { height: 's' })}>
        <div className={cnShowroom('Group')}>
          <BasicSelect
            placeholder="Выберите город"
            size="s"
